...
using DDD.Examples.Models;

namespace DDD.Examples.Application;
...
public class LotMetricService
{
    ...
    public void Execute(SGReaderLotMetricsRecordedV1 sGReaderLotMetricsRecorded)
    {
    ...
    public LotMetrics? QueryLotMetrics(string lotId)
    {
